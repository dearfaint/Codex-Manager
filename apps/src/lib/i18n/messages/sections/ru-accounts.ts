...
export const RU_ACCOUNTS_MESSAGES: MessageCatalog = {
  ...
  "用量限制": "Лимит usage",
  "已消耗 Tokens": "Потрачено токенов",
  已消耗金额: "Потрачено",
  已用占比: "Использовано %",
  按窗口内已消耗金额和当前用量占比反推:
    "Оценка по потраченной сумме в окне и текущей доле usage",
  估算方式: "Метод оценки",
  缺少消费记录: "Нет записей расхода",
  剩余占比: "Осталось %",
  统计中: "Расчёт",
  未获取用量: "Usage не получен",
  暂无消耗: "Расхода пока нет",
